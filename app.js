...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Diệu Liên ! ";
    let charArrTitle = textTitle.split('');
let text = "Chúc Liên giáng sinh vui vẻ,hạnh phúc,an khanh,thịnh vượng,phát tài,phát lộc,tiền vào như nước , sức khỏe dồi dào , lộc vào đầy nhà :)) . Và sống sót trong kì thi sắp tới nha !!!   "
